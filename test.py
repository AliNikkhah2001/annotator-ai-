# =============================================================
#  Candlestick Annotator – final working version
#  (make_figure removed, logic inlined)
# =============================================================
...
for k, v in state_defaults.items():
    st.session_state.setdefault(k, v)                     # initialise
...
# -------------------- main plot (make_figure logic inlined) ----------
